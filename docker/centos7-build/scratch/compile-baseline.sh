...
#ga_repository="https://github.com/molpro/ga"
#ga_version=molpro/5.8.2
ga_repository="https://github.com/GlobalArrays/ga"
ga_version=develop
make_processes=8
...
working_directory=$thisdir/install-Molpro-baseline # careful! if this directory already exists it will be completely destroyed first
...
git clone "$ga_repository" || exit 1
cd ga || exit 1
